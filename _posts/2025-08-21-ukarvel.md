...
categories:
 ...
 - c
 - avr
excerpt: </p><left><img src="/assets/RoboCar.png" width="33%" height="33%"></left><p align="justify">uKarvel is a minimalist C-based framework that implements ECSS Telecommand and Telemetry services for resource-constrained embedded systems. Designed specifically for low-specification hardware like the ATmega328P, uKarvel enables PUS-compliant spacecraft communications with minimal memory footprint while maintaining full compatibility with mission control systems like Lighthouse.
---
...
![ATmega328P Rover Implementation](/assets/robocar.jpg){: width="80%" }
...
![uKarvel in Operation](/assets/RoboCar.png){: width="80%" }
